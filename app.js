...
/***********************
Chord Tracker v1
- Manual/app-played chord stamping tied to the highlight tick
...
function updateChordTrackerUI(){
  ...
  btn.title = on ? "Stop Chord Tracker" : "Start Chord Tracker";
...
function stampChordTrackerChord(rawChord){
  ...
  const stampKey = [target.section, target.idx, target.slot, raw, Math.floor((Number(state.tick8)||0)/1)].join("|");
